...
const Sidebar = () => {
  const { boards, getCurrentBoard, setCurrentBoard } = useBoardStore()
            ...
            {boards.map((board) => (
              <div key={board.id} className="relative">
                <button
                  ...
                  className="group w-full flex items-center justify-between p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-slate-700 transition-all duration-200 interactive"
                >
                    ...
                    {!sidebarCollapsed && (
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-sm font-medium truncate text-gray-900 dark:text-slate-100 group-hover:text-blue-600 dark:group-hover:text-blue-400">
                            {board.title}
                          </span>
                        </div>
                      </div>
                  ...
                  {!sidebarCollapsed && (
                    <span
                      ...
                      onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') handleBoardOptions(e, board) }}
                      className="opacity-0 group-hover:opacity-100 p-1.5 hover:bg-gray-200 dark:hover:bg-slate-600 rounded-lg transition-colors focus-ring"
                    >
