...
const AddCardForm = ({ boardId, listId, onCancel, onAdd }) => {
  const { addCard, getCurrentBoard } = useBoardStore()
  ...
  return (
    <>
      <div className="bg-white dark:bg-slate-800/80 backdrop-blur-sm rounded-xl border border-gray-200 dark:border-slate-600/50 p-6 shadow-xl fade-in">
